...
from utils.replay_buffer_stoch import ReplayBuffer
...
class QN(object):
    ...
    def train_step(self, t, replay_buffer, lr, epsilon):
        """
        ...
        if (t > self.config.learning_start and t % self.config.learning_freq == 0):
            loss_eval, grad_eval = self.update_step(t, replay_buffer, lr, epsilon)
    ...
    def evaluate(self, env=None, num_episodes=None):
        ...
        for i in range(num_episodes):
            ...
            while True:
                ...
                replay_buffer.store_effect(idx, action, reward, done, 0.)
                state = new_state
