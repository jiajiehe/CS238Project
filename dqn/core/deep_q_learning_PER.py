...
class DQN(QN):
    ...
    def update_step(self, t, replay_buffer, lr):
        ...
        Returns:
            loss: (Q - Q_target)^2
        """
        #print replay_buffer.p

        (s_batch, a_batch, r_batch, sp_batch, done_mask_batch, weight_mask_batch), idxes = replay_buffer.sample(self.config.batch_size)
        ...
        fd = {
            ...
            self.weight_mask: weight_mask_batch,
            self.lr: lr, 
            # extra info
        ...
        diff_eval, loss_eval, grad_norm_eval, summary, _ = self.sess.run([self.diff, self.loss, self.grad_norm, 
                                                 self.merged, self.train_op], feed_dict=fd)
        #print diff_eval
        replay_buffer.update_p(diff_eval, idxes)
        #print replay_buffer.p
