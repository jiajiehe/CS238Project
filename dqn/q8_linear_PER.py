...
from core.deep_q_learning_PER import DQN
...
class Linear(DQN):
    ...
    def add_placeholders_op(self):
        ...
        self.weight_mask = tf.placeholder(tf.float32, None)
        ##############################################################
        ######################## END YOUR CODE #######################
    ...
    def add_loss_op(self, q, target_q):
        ...
        self.diff = tf.abs(samp_q - qa)
        self.loss = tf.reduce_mean(tf.subtract(samp_q,qa)**2 * self.weight_mask)
        ##############################################################
        ######################## END YOUR CODE #######################
